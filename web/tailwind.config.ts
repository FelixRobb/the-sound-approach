    ...
    extend: {
      colors: {
        ...
        destructive: {
          ...
          "container-foreground": "var(--destructive-container-foreground)",
        },
        success: {
          DEFAULT: "var(--success)",
          foreground: "var(--success-foreground)",
          container: "var(--success-container)",
          "container-foreground": "var(--success-container-foreground)",
        },
        warning: {
          DEFAULT: "var(--warning)",
          foreground: "var(--warning-foreground)",
          container: "var(--warning-container)",
          "container-foreground": "var(--warning-container-foreground)",
        },
        info: {
          DEFAULT: "var(--info)",
          foreground: "var(--info-foreground)",
          container: "var(--info-container)",
          "container-foreground": "var(--info-container-foreground)",
        },
        muted: {
          DEFAULT: "var(--muted)",
        ...
        surface: {
          ...
          "variant-foreground": "var(--surface-variant-foreground)",
          low: "var(--surface-low)",
